...
import { ContentChildrenOptions, ContentProps } from '@nodestrap/content';
...
export declare const usesCarouselItemsLayout: (options?: ContentChildrenOptions) => import("@cssfn/cssfn").Rule;
export declare const usesCarouselItemLayout: (options?: ContentChildrenOptions) => import("@cssfn/cssfn").Rule;
...
export declare const usesCarouselLayout: (options?: ContentChildrenOptions) => import("@cssfn/cssfn").Rule;
